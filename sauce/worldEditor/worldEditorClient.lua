...
initDefaultMode = function()
	...
	placingCancelBtn.parentDidResize = function()
		placingCancelBtn.pos = { Screen.Width * 0.5 - placingCancelBtn.Width * 0.1, placingCancelBtn.Height * 2 }
	end
	...
	placingValidateBtn.parentDidResize = function()
		...
		placingValidateBtn.pos = placingCancelBtn.pos
			+ { placingCancelBtn.Width + padding, placingCancelBtn.Height * 0.1 - placingValidateBtn.Height * 0.5, 0 }
	end
	...
	editMapValidateBtn.parentDidResize = function()
		editMapValidateBtn.pos = { Screen.Width * 0.5 - editMapValidateBtn.Width * 0.1, placingCancelBtn.Height * 2 }
	end
